...
namespace RC_Framework
{
    ...
    /// </summary>
    public class HealthBarAttached : RC_RenderableAttached
    {
        ...
        public HealthBarAttached(Color bar, Color backGround, Color barOffColorZ, int heightZ, bool alwaysDrawZ)
        {
            colour = bar;
