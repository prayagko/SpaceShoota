...
namespace RC_Framework
{
    ...
    public class Sprite16Step : Sprite3
    {
        ...
        public Sprite16Step(bool visibleZ, Texture2D texZ, float x, float y, int xsize, int ysize, int dirAnimInit) : base(visibleZ, texZ, x, y)
        {
                setXframes(4);
                setYframes(4);
        ...
        /// <summary>
        /// Set Hotspot to top left of animation - only works on frame animated sprites
        /// </summary>
        public void setHSTopLeft()
        {
            setHSoffset(new Vector2(0,0));
            //setBB(0,0, XframeWidth, YframeHeight);
        }
